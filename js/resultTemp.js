...
let inputObject = JSON.parse(localStorage.getItem("rainData"));

!function(){

  if(inputObject != null){
    document.getElementById('title-bar-output').innerText = `Rainfall Forecast Verification for ${inputObject.place}\n In the month of ${inputObject.month}, ${inputObject.year}`;
  }
  else {
