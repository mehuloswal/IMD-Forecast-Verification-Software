  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        {
          label: 'PC',
          data: [output.csi[0][0], output.csi[1][0],output.csi[2][0],output.csi[3][0],output.csi[4][0],],
          borderWidth: 1
        }
      ]
    },
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        {
          label: 'PC',
          data: [output.csi[0][1], output.csi[1][1],output.csi[2][1],output.csi[3][1],output.csi[4][1],],
          borderWidth: 1
        }
      ]
    },
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        {
          label: 'PC',
          data: [output.csi[0][2], output.csi[1][2],output.csi[2][2],output.csi[3][2],output.csi[4][2],],
          borderWidth: 1
        }
      ]
    },
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        {
          label: 'PC',
          data: [output.csi[0][3], output.csi[1][3],output.csi[2][3],output.csi[3][3],output.csi[4][3],],
          borderWidth: 1
        }
      ]
    },
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [
        {
          label: 'PC',
          data: [output.csi[0][4], output.csi[1][4],output.csi[2][4],output.csi[3][4],output.csi[4][4],],
          borderWidth: 1
        }
      ]
    },
